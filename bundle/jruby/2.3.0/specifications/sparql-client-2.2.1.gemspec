# -*- encoding: utf-8 -*-
# stub: sparql-client 2.2.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<net-http-persistent>.freeze, ["< 4", ">= 2.9"])
      s.add_development_dependency(%q<sparql>.freeze, ["< 4.0", ">= 2.2"])
      ...
      s.add_dependency(%q<net-http-persistent>.freeze, ["< 4", ">= 2.9"])
      s.add_dependency(%q<sparql>.freeze, ["< 4.0", ">= 2.2"])
