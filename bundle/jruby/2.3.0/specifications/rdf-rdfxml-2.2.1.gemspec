...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rdf-rdfa>.freeze, ["< 4.0", ">= 2.2"])
      ...
      s.add_development_dependency(%q<rdf-isomorphic>.freeze, ["< 4.0", ">= 2.2"])
      ...
      s.add_dependency(%q<rdf-rdfa>.freeze, ["< 4.0", ">= 2.2"])
      ...
      s.add_dependency(%q<rdf-isomorphic>.freeze, ["< 4.0", ">= 2.2"])
