...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rdf-aggregate-repo>.freeze, ["< 4.0", ">= 2.2"])
      ...
      s.add_runtime_dependency(%q<sparql-client>.freeze, ["< 4.0", ">= 2.1"])
      s.add_runtime_dependency(%q<rdf-xsd>.freeze, ["< 4.0", ">= 2.2"])
      ...
      s.add_development_dependency(%q<linkeddata>.freeze, ["< 4.0", ">= 2.2"])
      ...
      s.add_dependency(%q<linkeddata>.freeze, ["< 4.0", ">= 2.2"])
