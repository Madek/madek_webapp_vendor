# -*- encoding: utf-8 -*-
# stub: rdf-microdata 2.1.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<rack-cache>.freeze, ["~> 1.6"])
      s.add_development_dependency(%q<rest-client>.freeze, ["~> 1.8"])
      s.add_development_dependency(%q<rest-client-components>.freeze, ["~> 1.4"])
      s.add_development_dependency(%q<rspec>.freeze, ["~> 3.4"])
      s.add_development_dependency(%q<rspec-its>.freeze, ["~> 1.2"])
      s.add_development_dependency(%q<rdf-spec>.freeze, ["~> 2.0"])
      s.add_development_dependency(%q<rdf-rdfa>.freeze, ["~> 2.0"])
      ...
      s.add_dependency(%q<rack-cache>.freeze, ["~> 1.6"])
      s.add_dependency(%q<rest-client>.freeze, ["~> 1.8"])
      s.add_dependency(%q<rest-client-components>.freeze, ["~> 1.4"])
